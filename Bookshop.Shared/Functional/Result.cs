namespace Bookshop.Shared.Functional;
...
public class Result<T, E> : Result
{
    ...
    {
        return new Result<T, E>(data, default);
    }
    ...
    {
        return !IsSuccess ? Result<U, E>.Err(Error!) : func(Data!);
    }
    ...
    {
        return IsSuccess && Data != null ? Option<T>.Some(Data) : Option<T>.None();
    }
}
